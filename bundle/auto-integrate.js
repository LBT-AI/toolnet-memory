...
`.trim()}var Rt="<!-- TOOLNET_MEMORY_BOOTSTRAP_START -->",we="<!-- TOOLNET_MEMORY_BOOTSTRAP_END -->";function Ln(e={}){let t=Xe();Pt(S(),{recursive:!0});let o=`${Rt}
## ToolNet Memory
