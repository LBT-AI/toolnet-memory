...
`),this.active=!1}};async function ye(e,t,o={}){let n=new me(e,o).start();try{let r=await t();return n.succeed(),r}catch(r){throw n.fail(),r}}import{existsSync as Nt}from"node:fs";import{homedir as Yn}from"node:os";import{join as Wn}from"node:path";import{spawnSync as zn}from"node:child_process";import{homedir as vn}from"node:os";import{join as I}from"node:path";function st(e={}){return I(e.home??vn(),".gemini")}function ct(e={}){return I(st(e),"antigravity-cli")}function at(e={}){return I(st(e),"config")}function W(e={}){return I(at(e),"mcp_config.json")}function z(e={}){let t=e.cwd??process.cwd();return I(t,".agents","mcp_config.json")}function q(e="toolnet-memory",t={}){return I(ct(t),"plugins",e)}function lt(e={}){return[ct(e),W(e),at(e),z(e)]}import{homedir as ut}from"node:os";import{join as j}from"node:path";function x(e={}){let t=process.env.OPENCODE_CONFIG_DIR?.trim();if(t)return t;let o=e.xdgConfigHome??process.env.XDG_CONFIG_HOME?.trim();return o?j(o,"opencode"):j(e.home??ut(),".config","opencode")}function he(e={}){let t=process.env.OPENCODE_CONFIG?.trim();if(t)return t;let o=e.home??ut(),n=e.xdgConfigHome??process.env.XDG_CONFIG_HOME?.trim();return n?j(n,"opencode","opencode.json"):j(o,".config","opencode","opencode.json")}function ke(e={}){let t=e.cwd??process.cwd();return j(t,"opencode.json")}function pt(e={}){return j(x(e),"plugins")}function dt(e={}){return j(x(e),"AGENTS.md")}import{homedir as gt}from"node:os";import{join as be}from"node:path";function Ce(e={}){return be(e.home??gt(),".claude")}function ft(e={}){return be(Ce(e),"settings.json")}function mt(e={}){return be(e.home??gt(),".claude.json")}import{homedir as On}from"node:os";import{join as S}from"node:path";function we(e={}){return e.kiroHome??process.env.KIRO_HOME??S(e.home??On(),".kiro")}function jn(e={}){return S(we(e),"settings")}function V(e={}){return S(jn(e),"mcp.json")}function ve(e={}){let t=e.cwd??process.cwd();return S(t,".kiro","settings","mcp.json")}function Sn(e={}){return S(we(e),"hooks")}function Oe(e={}){return S(Sn(e),"toolnet-memory.json")}function je(e={}){let t=e.cwd??process.cwd();return S(t,".kiro","hooks","toolnet-memory.json")}function yt(e={}){return[we(e),V(e)]}import{homedir as In}from"node:os";import{join as Se}from"node:path";function ht(e={}){return Se(e.home??In(),".toolnetcli")}function xn(e={}){return Se(ht(e),"config.json")}function kt(e={}){let t=e.cwd??process.cwd();return Se(t,".toolnet","mcp.json")}function bt(e={}){let t=ht(e),o=xn(e);return[t,o]}import{homedir as Rn}from"node:os";import{join as Ie}from"node:path";function Ct(e={}){if(e.kiloHome)return e.kiloHome;if(process.env.KILO_HOME)return process.env.KILO_HOME;let t=e.xdgConfigHome??process.env.XDG_CONFIG_HOME;return t?Ie(t,"kilo"):Ie(e.home??Rn(),".config","kilo")}function xe(e={}){return Ie(Ct(e),"kilo.jsonc")}function wt(e={}){let t=Ct(e),o=xe(e);return[t,o]}import{homedir as Mn}from"node:os";import{join as k,resolve as Tn}from"node:path";function X(e={}){return e.cursorHome??k(e.home??Mn(),".cursor")}function En(e={}){return e.cursorConfigDir??process.env.CURSOR_CONFIG_DIR??(e.xdgConfigHome??process.env.XDG_CONFIG_HOME?k(e.xdgConfigHome??process.env.XDG_CONFIG_HOME,"cursor"):void 0)??X(e)}function Q(e={}){return k(X(e),"mcp.json")}function Z(e={}){return k(X(e),"hooks.json")}function Re(e){return k(Tn(e),".cursor")}function vt(e){return k(Re(e),"mcp.json")}function Ot(e){return k(Re(e),"hooks.json")}function Fn(e){return k(Re(e),"rules")}function jt(e){return k(Fn(e),"toolnet-memory.mdc")}function St(e={}){return Array.from(new Set([X(e),En(e)]))}import{homedir as Pn}from"node:os";import{join as h,resolve as An}from"node:path";function Me(e={}){return e.copilotHome??process.env.COPILOT_HOME??h(e.home??Pn(),".copilot")}function ee(e={}){return h(Me(e),"mcp-config.json")}function Nn(e={}){return h(Me(e),"hooks")}function te(e={}){return h(Nn(e),"toolnet-memory.json")}function Te(e){return h(An(e),".github")}function It(e){return h(Te(e),"mcp.json")}function _n(e){return h(Te(e),"hooks")}function xt(e){return h(_n(e),"toolnet-memory.json")}function Dn(e){return h(Te(e),"instructions")}function Rt(e){return h(Dn(e),"toolnet-memory.instructions.md")}function Mt(e={}){return[Me(e)]}import{homedir as $n}from"node:os";import{join as y,resolve as Hn}from"node:path";function oe(e={}){return e.grokHome??process.env.GROK_HOME??y(e.home??$n(),".grok")}function ne(e={}){return y(oe(e),"config.toml")}function Jn(e={}){return y(oe(e),"hooks")}function re(e={}){return y(Jn(e),"toolnet-memory.json")}function Ln(e={}){return y(oe(e),"skills")}function Gn(e={}){return y(Ln(e),"toolnet-continuity")}function ie(e={}){return y(Gn(e),"SKILL.md")}function Ee(e){return y(Hn(e),".grok")}function Tt(e){return y(Ee(e),"config.toml")}function Kn(e){return y(Ee(e),"hooks")}function Et(e){return y(Kn(e),"toolnet-memory.json")}function Bn(e){return y(Ee(e),"skills")}function Un(e){return y(Bn(e),"toolnet-continuity")}function Ft(e){return y(Un(e),"SKILL.md")}function Pt(e={}){return[oe(e)]}function qn(e){return zn("sh",["-lc",`command -v ${JSON.stringify(e)} >/dev/null 2>&1`],{stdio:"ignore"}).status===0}function v(e){let t=e.commandExists(e.command),o=e.configPaths.filter(s=>Nt(s)),n=o.length>0,r=[];t&&r.push(`command:${e.command}`);for(let s of o)r.push(`config:${s}`);return{agent:e.agent,detected:t||n,commandDetected:t,configDetected:n,evidence:r}}function At(e){let t=e.commands.filter(i=>e.commandExists(i)),o=e.configPaths.filter(i=>Nt(i)),n=t.length>0,r=o.length>0,s=[...t.map(i=>`command:${i}`),...o.map(i=>`config:${i}`)];return{agent:e.agent,detected:n||r,commandDetected:n,configDetected:r,evidence:s}}function _t(e={}){let t=e.home??Yn(),o=e.commandExists??qn,n=e.codexHome??process.env.CODEX_HOME??Wn(t,".codex");return[v({agent:"agy",command:"agy",commandExists:o,configPaths:lt({home:t})}),v({agent:"opencode",command:"opencode",commandExists:o,configPaths:[x({home:t,xdgConfigHome:e.xdgConfigHome})]}),v({agent:"claude",command:"claude",commandExists:o,configPaths:[Ce({home:t})]}),v({agent:"kiro",command:"kiro-cli",commandExists:o,configPaths:yt({home:t,kiroHome:e.kiroHome})}),At({agent:"cursor",commands:["agent","cursor-agent"],commandExists:o,configPaths:St({home:t,cursorHome:e.cursorHome,cursorConfigDir:e.cursorConfigDir,xdgConfigHome:e.xdgConfigHome})}),v({agent:"copilot",command:"copilot",commandExists:o,configPaths:Mt({home:t,copilotHome:e.copilotHome})}),v({agent:"grok",command:"grok",commandExists:o,configPaths:Pt({home:t,grokHome:e.grokHome})}),v({agent:"toolnet-cli",command:"toolnet",commandExists:o,configPaths:bt({home:t})}),At({agent:"kilo",commands:["kilo","kilo-code"],commandExists:o,configPaths:wt({home:t,kiloHome:e.kiloHome})}),v({agent:"codex",command:"codex",commandExists:o,configPaths:[n]})]}import{existsSync as fr,mkdirSync as Gt,readFileSync as mr,renameSync as yr,writeFileSync as hr}from"node:fs";import{dirname as kr,join as ce}from"node:path";import{existsSync as Vn,mkdirSync as Xn,readFileSync as Qn,renameSync as Zn,rmSync as er,writeFileSync as tr}from"node:fs";import{dirname as or,join as nr}from"node:path";function rr(e){return`'${e.replace(/'/g,"'\\''")}'`}function ir(e){if(!Vn(e))return{};let t;try{t=JSON.parse(Qn(e,"utf8"))}catch{throw new Error(`Invalid existing Agy hooks.json at ${e}: parse error. Not overwriting.`)}if(typeof t!="object"||t===null||Array.isArray(t))throw new Error(`Invalid existing Agy hooks.json at ${e}: root must be a JSON object.`);return t}function sr(e,t){Xn(or(e),{recursive:!0,mode:448});let o=`${e}.tmp-${process.pid}-${Date.now()}`;try{tr(o,`${JSON.stringify(t,null,2)}
`,{encoding:"utf8",mode:384}),Zn(o,e)}finally{er(o,{force:!0})}}function Dt(e={}){let t=e.pluginName??"toolnet-memory",o=e.hooksFile??nr(q(t),"hooks.json"),n=ir(o),r=e.binary??process.env.TOOLNET_MEMORY_BIN??"toolnet-memory",s=`${rr(r)} session:agy-hook`;return n["toolnet-memory"]={enabled:!0,PreToolUse:[{matcher:"view_file|list_dir|find_by_name|grep_search|run_command",hooks:[{type:"command",command:`${s} pre-tool`,timeout:5}]}],PreInvocation:[{type:"command",command:`${s} pre`,timeout:15}],PostInvocation:[{type:"command",command:`${s} post`,timeout:15}],Stop:[{type:"command",command:`${s} stop`,timeout:30}]},sr(o,n),o}import{existsSync as cr,mkdirSync as ar,readFileSync as lr,renameSync as ur,writeFileSync as pr}from"node:fs";import{dirname as dr}from"node:path";function N(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function gr(e,t){ar(dr(e),{recursive:!0,mode:448});let o=`${e}.tmp-${process.pid}-${Date.now()}`;pr(o,`${JSON.stringify(t,null,2)}
`,{encoding:"utf8",mode:384}),ur(o,e)}function $t(e){if(!cr(e))return{};let t=lr(e,"utf8").trim();if(!t)return{};let o;try{o=JSON.parse(t)}catch{throw new Error(`Invalid existing Agy MCP config at ${e}: parse error. Not overwriting.`)}if(!N(o))throw new Error(`Invalid existing Agy MCP config at ${e}: root must be a JSON object. Not overwriting.`);return o}function Ht(e,t){return N(e)?e.command===t&&Array.isArray(e.args)&&e.args.length===1&&e.args[0]==="mcp":!1}function se(e,t,o,n){let r=$t(e),s=r.mcpServers;if(s!==void 0&&!N(s))throw new Error(`Invalid existing Agy MCP config: mcpServers must be an object in ${e}.`);let i=N(s)?{...s}:{},c=i[o];if(Ht(c,t)&&!n)return{installed:!0,changed:!1};i[o]={command:t,args:["mcp"]};let a={...r,mcpServers:i};gr(e,a);let u=$t(e).mcpServers;if(!N(u)||!Ht(u[o],t))throw new Error(`Agy MCP configuration was written but verification failed for ${e}.`);return{installed:!0,changed:!0}}function Jt(e={}){let t=e.binary??process.env.TOOLNET_MEMORY_BIN??"toolnet-memory",o=e.serverName??"toolnet-memory",n=e.scope??"global";if(e.configFile)return{...se(e.configFile,t,o,e.force??!1),configFile:e.configFile,serverName:o,command:t,args:["mcp"]};if(n==="both"){let i=W(),c=z({cwd:e.cwd}),a=se(i,t,o,e.force??!1),l=se(c,t,o,e.force??!1);return{installed:!0,changed:a.changed||l.changed,configFile:i,serverName:o,command:t,args:["mcp"]}}let r=n==="workspace"?z({cwd:e.cwd}):W();return{...se(r,t,o,e.force??!1),configFile:r,serverName:o,command:t,args:["mcp"]}}var br=`# ToolNet Memory Continuity
...
`.trim()}var Yt="<!-- TOOLNET_MEMORY_BOOTSTRAP_START -->",Fe="<!-- TOOLNET_MEMORY_BOOTSTRAP_END -->";function jr(e={}){let t=dt();Wt(x(),{recursive:!0});let o=`${Yt}
## ToolNet Memory
...
${Fe}`,n=vr(t)?Or(t,"utf8"):"",r=n.indexOf(Yt),s=n.indexOf(Fe);return r>=0&&s>=r?n=n.slice(0,r)+o+n.slice(s+Fe.length):(n=n.trimEnd(),n&&(n+=`

`),n+=o),zt(t,n.trimEnd()+`
`,{encoding:"utf8",mode:384}),t}function qt(e={}){let t=e.binary??process.env.TOOLNET_MEMORY_BIN??"toolnet-memory",o=[];o.push(jr({cwd:e.cwd}));let n=e.scope??"global",r=[];if((n==="global"||n==="both")&&r.push(e.directory??pt()),n==="project"||n==="both"){let s=e.cwd??process.cwd();r.push(Ut(s,".opencode","plugins"))}for(let s of r){Wt(s,{recursive:!0});let i=Ut(s,"toolnet-memory.js"),c=`
...
`;zt(i,c.trimStart(),{encoding:"utf8",mode:384}),o.push(i)}return o}import{existsSync as Qt,mkdirSync as Sr,readFileSync as Ir,renameSync as xr,writeFileSync as Rr}from"node:fs";import{dirname as Zt,join as Mr}from"node:path";function _(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function Tr(e,t){Sr(Zt(e),{recursive:!0});let o=`${e}.tmp-${process.pid}-${Date.now()}`;Rr(o,`${JSON.stringify(t,null,2)}
`,{encoding:"utf8",mode:384}),xr(o,e)}function Vt(e){if(!Qt(e))return{};let t=Ir(e,"utf8").trim();if(!t)return{};let o;try{o=JSON.parse(t)}catch{throw new Error(`Invalid existing OpenCode config at ${e}: parse error. Not overwriting.`)}if(!_(o))throw new Error(`Invalid existing OpenCode config at ${e}: root must be a JSON object. Not overwriting.`);return o}function Xt(e,t){if(!_(e))return!1;let o=e.command;return e.type==="local"&&e.enabled!==!1&&Array.isArray(o)&&o.length===2&&o[0]===t&&o[1]==="mcp"}function ae(e,t,o,n){let r=Mr(Zt(e),"opencode.jsonc"),s=Qt(r)?r:void 0,i=Vt(e),c=i.mcp;if(c!==void 0&&!_(c))throw new Error(`Invalid existing OpenCode config: mcp must be an object in ${e}.`);let a=_(c)?{...c}:{},l=a[o];if(Xt(l,t)&&!n)return{installed:!0,changed:!1,preservedJsonc:s};a[o]={type:"local",command:[t,"mcp"],enabled:!0};let u={...i,mcp:a};Tr(e,u);let p=Vt(e);if(!_(p.mcp)||!Xt(p.mcp[o],t))throw new Error(`OpenCode MCP configuration was written but verification failed for ${e}.`);return{installed:!0,changed:!0,preservedJsonc:s}}function eo(e={}){let t=e.binary??process.env.TOOLNET_MEMORY_BIN??"toolnet-memory",o=e.serverName??"toolnet-memory",n=e.scope??"global";if(e.configFile)return{...ae(e.configFile,t,o,e.force??!1),configFile:e.configFile,serverName:o,command:[t,"mcp"]};if(n==="both"){let i=he(),c=ke({cwd:e.cwd}),a=ae(i,t,o,e.force??!1),l=ae(c,t,o,e.force??!1);return{installed:!0,changed:a.changed||l.changed,configFile:i,serverName:o,command:[t,"mcp"],preservedJsonc:a.preservedJsonc??l.preservedJsonc}}let r=n==="project"?ke({cwd:e.cwd}):he();return{...ae(r,t,o,e.force??!1),configFile:r,serverName:o,command:[t,"mcp"]}}import{existsSync as Er,mkdirSync as to,readFileSync as Fr,writeFileSync as oo}from"node:fs";import{homedir as no}from"node:os";import{dirname as ro,join as Pe}from"node:path";function Pr(e){let t=[],o=/"((?:\\.|[^"\\])*)"|'([^']*)'/g,n;for(;n=o.exec(e);){let r=n[1]??n[2]??"";try{t.push(n[1]!==void 0?JSON.parse(`"${r}"`):r)}catch{t.push(r)}}return t}function io(e={}){let t=e.configFile??Pe(process.env.CODEX_HOME??Pe(no(),".codex"),"config.toml"),o=e.previousFile??Pe(no(),".config","toolnet-memory","codex-notify-previous.json");to(ro(t),{recursive:!0}),to(ro(o),{recursive:!0});let n=Er(t)?Fr(t,"utf8"):"",r=e.binary??"toolnet-memory",s=`notify = [${JSON.stringify(r)}, "session:codex-notify"]`,i=n.split(`
...
`);u=Pr(d),i.splice(a,l-a+1,s)}else c=i.findIndex(d=>/^\s*\[/.test(d)),c<0&&(c=i.length),i.splice(c,0,s);let p=u.length>=2&&u[u.length-1]==="session:codex-notify";return u.length>0&&!p&&oo(o,JSON.stringify(u,null,2)+`
`,{encoding:"utf8",mode:384}),n=i.join(`
`),n.endsWith(`
`)||(n+=`
`),oo(t,n,{encoding:"utf8",mode:384}),{configFile:t,previousFile:o,preservedPrevious:u.length>0&&!p}}import{existsSync as Ar,mkdirSync as Nr,readFileSync as _r,writeFileSync as Dr}from"node:fs";import{homedir as $r}from"node:os";import{dirname as Hr,join as so}from"node:path";function Jr(e){return`'${e.replace(/'/g,"'\\''")}'`}function co(e={}){let t=e.hooksFile??so(process.env.CODEX_HOME??so($r(),".codex"),"hooks.json");Nr(Hr(t),{recursive:!0});let o={};if(Ar(t))try{o=JSON.parse(_r(t,"utf8"))}catch(c){throw new Error(`Invalid existing Codex hooks.json: ${c instanceof Error?c.message:String(c)}`)}let n=o.hooks&&typeof o.hooks=="object"&&!Array.isArray(o.hooks)?o.hooks:{};o.hooks=n;let s=(Array.isArray(n.SessionStart)?n.SessionStart:[]).filter(c=>{try{return!JSON.stringify(c).includes("session:codex-context")}catch{return!0}}),i=e.binary??"toolnet-memory";return s.push({matcher:"startup|resume|clear|compact",hooks:[{type:"command",command:`${Jr(i)} session:codex-context`,timeout:15,additionalContextLimit:1e3,statusMessage:"Loading ToolNet project continuity"}]}),n.SessionStart=s,Dr(t,JSON.stringify(o,null,2)+`
`,{encoding:"utf8",mode:384}),t}import{spawnSync as Lr}from"node:child_process";function Ae(e,t){return Lr(e,t,{encoding:"utf8",stdio:["ignore","pipe","pipe"]})}function ao(e,t){let o=Ae(e,["mcp","get",t,"--json"]);if(o.status!==0||!o.stdout)return null;try{return JSON.parse(o.stdout)}catch{return null}}function lo(e,t){return e.enabled!==!1&&e.transport?.type==="stdio"&&e.transport?.command===t&&Array.isArray(e.transport?.args)&&e.transport?.args.length===1&&e.transport.args[0]==="mcp"}function uo(e={}){let t=e.binary??process.env.TOOLNET_MEMORY_BIN??"toolnet-memory",o=e.codexBinary??"codex",n=e.serverName??"toolnet-memory",r=ao(o,n);if(r&&lo(r,t))return{installed:!0,changed:!1,serverName:n,command:t,args:["mcp"]};if(r){let c=Ae(o,["mcp","remove",n]);if(c.status!==0)return{installed:!1,changed:!1,serverName:n,command:t,args:["mcp"],error:(c.stderr||c.stdout||"Unable to remove old ToolNet MCP configuration.").trim()}}let s=Ae(o,["mcp","add",n,"--",t,"mcp"]);if(s.status!==0)return{installed:!1,changed:!1,serverName:n,command:t,args:["mcp"],error:(s.stderr||s.stdout||"Unable to register ToolNet MCP.").trim()};let i=ao(o,n);return!i||!lo(i,t)?{installed:!1,changed:!0,serverName:n,command:t,args:["mcp"],error:"Codex accepted MCP registration but verification did not match expected ToolNet command."}:{installed:!0,changed:!0,serverName:n,command:t,args:["mcp"]}}import{existsSync as Gr,mkdirSync as Kr,readFileSync as Br,renameSync as Ur,rmSync as Yr,writeFileSync as Wr}from"node:fs";import{dirname as zr}from"node:path";function D(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function qr(e){return/^[A-Za-z0-9_./:-]+$/u.test(e)?e:`'${e.replace(/'/gu,"'\\''")}'`}function Vr(e){if(!Gr(e))return{};let t;try{t=JSON.parse(Br(e,"utf8"))}catch(o){throw new Error(`Invalid existing Claude settings.json: ${o instanceof Error?o.message:String(o)}`)}if(!D(t))throw new Error("Invalid existing Claude settings.json: root must be a JSON object.");return t}function Ne(e){if(e===void 0)return[];if(!Array.isArray(e))throw new Error("Invalid existing Claude settings.json: hook event must be an array.");let t=[];for(let o of e){if(!D(o)){t.push(o);continue}let n=o.hooks;if(!Array.isArray(n)){t.push(o);continue}let r=n.filter(s=>{if(!D(s))return!0;let i=s.command;return!(typeof i=="string"&&i.includes("session:claude-hook"))});r.length!==0&&t.push({...o,hooks:r})}return t}function _e(e){return{type:"command",command:e,timeout:10}}function Xr(e,t){Kr(zr(e),{recursive:!0,mode:448});let o=`${e}.toolnet-${process.pid}-${Date.now()}.tmp`;try{Wr(o,JSON.stringify(t,null,2)+`
`,{encoding:"utf8",mode:384}),Ur(o,e)}finally{Yr(o,{force:!0})}}function po(e={}){let t=e.settingsFile??ft(),o=e.binary??process.env.TOOLNET_MEMORY_BIN??"toolnet-memory",n=Vr(t),r=n.hooks;if(r!==void 0&&!D(r))throw new Error("Invalid existing Claude settings.json: hooks must be an object.");let s=D(r)?{...r}:{},i=`${qr(o)} session:claude-hook`,c=Ne(s.SessionStart);c.push({matcher:"startup|resume|clear|compact",hooks:[_e(i)]}),s.SessionStart=c;let a=Ne(s.PostToolUse);a.push({matcher:"Edit|Write",hooks:[_e(i)]}),s.PostToolUse=a;let l=Ne(s.Stop);l.push({hooks:[_e(i)]}),s.Stop=l;let u={...n,hooks:s},p=JSON.stringify(n),d=JSON.stringify(u);return p===d?{settingsFile:t,changed:!1}:(Xr(t,u),{settingsFile:t,changed:!0})}import{existsSync as Qr,mkdirSync as Zr,readFileSync as ei,renameSync as ti,rmSync as oi,writeFileSync as ni}from"node:fs";import{dirname as ri}from"node:path";function $(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function go(e){if(!Qr(e))return{};let t;try{t=JSON.parse(ei(e,"utf8"))}catch(o){throw new Error(`Invalid existing Claude Code config: ${o instanceof Error?o.message:String(o)}`)}if(!$(t))throw new Error("Invalid existing Claude Code config: root must be a JSON object.");return t}function fo(e,t){if(!$(e))return!1;let o=e.args;return e.type==="stdio"&&e.command===t&&Array.isArray(o)&&o.length===1&&o[0]==="mcp"}function ii(e,t){Zr(ri(e),{recursive:!0});let o=`${e}.toolnet-${process.pid}-${Date.now()}.tmp`;try{ni(o,JSON.stringify(t,null,2)+`
...
`,{encoding:"utf8",mode:384}),li(o,e)}finally{ui(o,{force:!0})}}function le(e,t,o){let n=ho(e);if(n.version!==void 0&&n.version!=="v1")throw new Error(`Unsupported existing Kiro hooks version: ${String(n.version)}`);let r=n.hooks;if(r!==void 0&&!Array.isArray(r))throw new Error("Invalid existing Kiro hooks file: hooks must be an array.");let s=Array.isArray(r)?r.filter(l=>!ko(l)):[],i=fi(t),c={...n,version:"v1",hooks:[...s,...i]};if(!o&&JSON.stringify(n)===JSON.stringify(c))return{changed:!1,hookCount:i.length};mi(e,c);let a=ho(e);if(a.version!=="v1"||!Array.isArray(a.hooks)||a.hooks.filter(ko).length!==i.length)throw new Error("Kiro hooks were written but verification failed.");return{changed:!0,hookCount:i.length}}function Co(e={}){let t=e.binary??process.env.TOOLNET_MEMORY_BIN??"toolnet-memory",o=e.scope??"global",n=`${gi(t)} session:kiro-hook`;if(e.hooksFile){let i=le(e.hooksFile,n,e.force??!1);return{hooksFile:e.hooksFile,...i}}if(o==="both"){let i=Oe(),c=je({cwd:e.cwd}),a=le(i,n,e.force??!1),l=le(c,n,e.force??!1);return{hooksFile:i,changed:a.changed||l.changed,hookCount:a.hookCount}}let r=o==="project"?je({cwd:e.cwd}):Oe(),s=le(r,n,e.force??!1);return{hooksFile:r,...s}}import{existsSync as yi,mkdirSync as hi,readFileSync as ki,renameSync as bi,rmSync as Ci,writeFileSync as wi}from"node:fs";import{dirname as vi}from"node:path";function J(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function wo(e){if(!yi(e))return{};let t=ki(e,"utf8").trim();if(!t)return{};let o;try{o=JSON.parse(t)}catch{throw new Error(`Invalid existing Kiro MCP config at ${e}: parse error. Not overwriting.`)}if(!J(o))throw new Error(`Invalid existing Kiro MCP config at ${e}: root must be a JSON object. Not overwriting.`);return o}function vo(e,t){return J(e)?e.command===t&&Array.isArray(e.args)&&e.args.length===1&&e.args[0]==="mcp"&&e.disabled===!1:!1}function Oi(e,t){hi(vi(e),{recursive:!0,mode:448});let o=`${e}.tmp-${process.pid}-${Date.now()}`;try{wi(o,`${JSON.stringify(t,null,2)}
`,{encoding:"utf8",mode:384}),bi(o,e)}finally{Ci(o,{force:!0})}}function ue(e,t,o,n){let r=wo(e),s=r.mcpServers;if(s!==void 0&&!J(s))throw new Error(`Invalid existing Kiro MCP config: mcpServers must be an object in ${e}.`);let i=J(s)?{...s}:{},c=i[o];if(vo(c,t)&&!n)return{installed:!0,changed:!1};i[o]={command:t,args:["mcp"],disabled:!1};let a={...r,mcpServers:i};Oi(e,a);let u=wo(e).mcpServers;if(!J(u)||!vo(u[o],t))throw new Error(`Kiro MCP configuration was written but verification failed for ${e}.`);return{installed:!0,changed:!0}}function Oo(e={}){let t=e.binary??process.env.TOOLNET_MEMORY_BIN??"toolnet-memory",o=e.serverName??"toolnet-memory",n=e.scope??"global";if(e.configFile)return{...ue(e.configFile,t,o,e.force??!1),configFile:e.configFile,serverName:o,command:t,args:["mcp"]};if(n==="both"){let i=V(),c=ve({cwd:e.cwd}),a=ue(i,t,o,e.force??!1),l=ue(c,t,o,e.force??!1);return{installed:!0,changed:a.changed||l.changed,configFile:i,serverName:o,command:t,args:["mcp"]}}let r=n==="project"?ve({cwd:e.cwd}):V();return{...ue(r,t,o,e.force??!1),configFile:r,serverName:o,command:t,args:["mcp"]}}function jo(e={}){let t=e.binary??process.env.TOOLNET_MEMORY_BIN??"toolnet-memory",o=Oo({binary:t,configFile:e.configFile,scope:e.scope,cwd:e.cwd,force:e.force}),n=Co({binary:t,hooksFile:e.hooksFile,scope:e.scope,cwd:e.cwd,force:e.force});return{installed:o.installed,changed:o.changed||n.changed,mcp:o,hooks:n,files:[o.configFile,n.hooksFile]}}import{existsSync as ji,mkdirSync as Si,readFileSync as Ii,renameSync as xi,rmSync as Ri,writeFileSync as Mi}from"node:fs";import{dirname as Ti}from"node:path";function De(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function Ei(e){if(!ji(e))return{};let t=Ii(e,"utf8").trim();if(!t)return{};let o;try{o=JSON.parse(t)}catch{throw new Error(`Invalid existing ToolNet CLI MCP config at ${e}: parse error. Not overwriting.`)}if(!De(o))throw new Error(`Invalid existing ToolNet CLI MCP config at ${e}: root must be a JSON object. Not overwriting.`);return o}function Fi(e,t){Si(Ti(e),{recursive:!0,mode:448});let o=`${e}.tmp-${process.pid}-${Date.now()}`;try{Mi(o,`${JSON.stringify(t,null,2)}
`,{encoding:"utf8",mode:384}),xi(o,e)}finally{Ri(o,{force:!0})}}function So(e={}){let t=e.binary??"toolnet-memory",o=e.configFile??kt({cwd:e.cwd}),n=Ei(o),r="toolnet-memory";if(De(n.mcpServers)&&n.mcpServers[r]!=null&&!e.force)return{installed:!0,changed:!1,configFile:o};let i=De(n.mcpServers)?{...n.mcpServers}:{};return i[r]={command:t,args:["mcp"]},n.mcpServers=i,Fi(o,n),{installed:!0,changed:!0,configFile:o}}function Io(e={}){let t=e.binary??"toolnet-memory",o=So({binary:t,configFile:e.configFile,force:e.force,cwd:e.cwd});return{installed:o.installed,changed:o.changed,mcp:{...o,configured:o.installed},files:[o.configFile]}}import{mkdirSync as Ji,existsSync as Li}from"node:fs";import{dirname as Gi}from"node:path";import{existsSync as Pi,mkdirSync as Ai,readFileSync as Ni,renameSync as _i,rmSync as Di,writeFileSync as $i}from"node:fs";import{dirname as Hi}from"node:path";function m(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function O(e,t){if(!Pi(e))return{};let o=Ni(e,"utf8").trim();if(!o)return{};let n;try{n=JSON.parse(o)}catch(r){throw new Error(`Invalid existing ${t} MCP config: ${r instanceof Error?r.message:String(r)}`)}if(!m(n))throw new Error(`Invalid existing ${t} MCP config: root must be a JSON object.`);return n}function M(e,t){Ai(Hi(e),{recursive:!0,mode:448});let o=`${e}.tmp-${process.pid}-${Date.now()}`;try{$i(o,`${JSON.stringify(t,null,2)}
`,{encoding:"utf8",mode:384}),_i(o,e)}finally{Di(o,{force:!0})}}function xo(e={}){let t=e.binary??"toolnet-memory",o=e.configFile??xe(),n=Gi(o);Li(n)||Ji(n,{recursive:!0});let r=O(o,"Kilo"),s=r.mcp;if(s!==void 0&&!m(s))throw new Error("Invalid existing Kilo config: mcp must be an object.");let i=m(s)?{...s}:{},c="toolnet-memory";return m(i[c])&&!e.force?{installed:!0,changed:!1,configFile:o,configured:!0}:(i[c]={type:"local",command:[t,"mcp"],enabled:!0,timeout:1e4},M(o,{...r,mcp:i}),{installed:!0,changed:!0,configFile:o,configured:!0})}function Ro(e={}){let t=e.binary??"toolnet-memory",o=xo({binary:t,configFile:e.configFile,force:e.force});return{installed:o.installed,changed:o.changed,mcp:o,files:[o.configFile]}}import{existsSync as Ki,mkdirSync as Bi,readFileSync as Ui,renameSync as Yi,rmSync as Wi,writeFileSync as zi}from"node:fs";import{dirname as qi}from"node:path";function g(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function b(e,t){if(!Ki(e))return{};let o=Ui(e,"utf8").trim();if(!o)return{};let n;try{n=JSON.parse(o)}catch(r){throw new Error(`Invalid existing ${t} hooks file: ${r instanceof Error?r.message:String(r)}`)}if(!g(n))throw new Error(`Invalid existing ${t} hooks file: root must be a JSON object.`);return n}function T(e,t){Bi(qi(e),{recursive:!0,mode:448});let o=`${e}.toolnet-${process.pid}-${Date.now()}.tmp`;try{zi(o,`${JSON.stringify(t,null,2)}
`,{encoding:"utf8",mode:384}),Yi(o,e)}finally{Wi(o,{force:!0})}}function $e(e){return/^[A-Za-z0-9_./:-]+$/u.test(e)?e:`'${e.replace(/'/gu,"'\\''")}'`}var L=[["sessionStart",10],["beforeSubmitPrompt",10],["preToolUse",10],["postToolUse",15],["afterAgentResponse",15],["stop",30]];function Mo(e){return g(e)&&typeof e.command=="string"&&e.command.includes("session:cursor-hook")}function Vi(e,t,o){let r={type:"command",command:`TOOLNET_HOOK_EVENT=${$e(e)} ${$e(t)} session:cursor-hook`,timeout:o};return e==="preToolUse"&&(r.matcher=".*"),r}function He(e={}){let t=e.hooksFile??Z(),o=e.binary??process.env.TOOLNET_MEMORY_BIN??"toolnet-memory",n=b(t,"Cursor");if(n.version!==void 0&&n.version!==1)throw new Error(`Unsupported existing Cursor hooks version: ${String(n.version)}`);let r=n.hooks;if(r!==void 0&&!g(r))throw new Error("Invalid existing Cursor hooks file: hooks must be an object.");let s=g(r)?{...r}:{};for(let[l,u]of L){let p=s[l];if(p!==void 0&&!Array.isArray(p))throw new Error(`Invalid existing Cursor hooks file: hooks.${l} must be an array.`);let d=Array.isArray(p)?p.filter(P=>!Mo(P)):[];s[l]=[...d,Vi(l,o,u)]}let i={...n,version:1,hooks:s};if(JSON.stringify(n)===JSON.stringify(i))return{hooksFile:t,changed:!1,hookCount:L.length};T(t,i);let c=b(t,"Cursor");if(c.version!==1||!g(c.hooks))throw new Error("Cursor hooks were written but verification failed.");let a=0;for(let[l]of L){let u=c.hooks[l];if(!Array.isArray(u))throw new Error("Cursor hooks were written but verification failed.");a+=u.filter(Mo).length}if(a!==L.length)throw new Error("Cursor hooks were written but verification failed.");return{hooksFile:t,changed:!0,hookCount:L.length}}function To(e,t){return m(e)?(e.type===void 0||e.type==="stdio")&&e.command===t&&Array.isArray(e.args)&&e.args.length===1&&e.args[0]==="mcp":!1}function Je(e={}){let t=e.configFile??Q(),o=e.binary??process.env.TOOLNET_MEMORY_BIN??"toolnet-memory",n=e.serverName??"toolnet-memory",r=O(t,"Cursor"),s=r.mcpServers;if(s!==void 0&&!m(s))throw new Error("Invalid existing Cursor MCP config: mcpServers must be an object.");let i=m(s)?{...s}:{};if(To(i[n],o))return{installed:!0,changed:!1,configFile:t,serverName:n,command:o,args:["mcp"]};i[n]={type:"stdio",command:o,args:["mcp"]},M(t,{...r,mcpServers:i});let a=O(t,"Cursor").mcpServers;if(!m(a)||!To(a[n],o))throw new Error("Cursor MCP configuration was written but verification failed.");return{installed:!0,changed:!0,configFile:t,serverName:n,command:o,args:["mcp"]}}import{mkdirSync as Xi,readFileSync as Eo,renameSync as Qi,rmSync as Zi,writeFileSync as es}from"node:fs";import{dirname as ts}from"node:path";var Le=`---
...
Current repository evidence overrides stale memory.
`;function os(e,t){Xi(ts(e),{recursive:!0,mode:448});let o=`${e}.toolnet-${process.pid}-${Date.now()}.tmp`;try{es(o,t,{encoding:"utf8",mode:384}),Qi(o,e)}finally{Zi(o,{force:!0})}}function Fo(e){let t=e.ruleFile??jt(e.projectRoot);try{if(Eo(t,"utf8")===Le)return{ruleFile:t,changed:!1}}catch{}if(os(t,Le),Eo(t,"utf8")!==Le)throw new Error("Cursor ToolNet project rule was written but verification failed.");return{ruleFile:t,changed:!0}}import{spawnSync as ns}from"node:child_process";import{existsSync as E,statSync as rs}from"node:fs";import{dirname as is,join as ss,parse as cs,resolve as Ke}from"node:path";function Po(e){let t=Ke(e);if(!E(t))throw new Error(`Project path does not exist: ${t}`);if(!rs(t).isDirectory())throw new Error(`Project path is not a directory: ${t}`);return t}function pe(e){return ss(e,".toolnet","project.json")}function as(e){let t=Ke(e),o=cs(t).root;for(;;){if(E(pe(t)))return t;if(t===o)return;let n=is(t);if(n===t)return;t=n}}function Ge(e){let t=ns("git",["rev-parse","--show-toplevel"],{cwd:e,encoding:"utf8",timeout:5e3});if(t.status!==0)return;let o=t.stdout.trim();return o?Ke(o):void 0}function C(e={}){let t=Po(e.cwd??process.cwd());if(e.project){let r=Po(e.project),s=pe(r),i=Ge(r);return{root:r,source:"explicit",eligible:!0,toolnetProject:E(s),manifestFile:E(s)?s:void 0,gitRoot:i}}let o=as(t);if(o){let r=pe(o);return{root:o,source:"toolnet",eligible:!0,toolnetProject:!0,manifestFile:r,gitRoot:Ge(o)}}let n=Ge(t);if(n){let r=pe(n);return{root:n,source:"git",eligible:!0,toolnetProject:E(r),manifestFile:E(r)?r:void 0,gitRoot:n}}return{root:t,source:"cwd",eligible:!1,toolnetProject:!1}}function Do(e,t={}){let o=[],n=e.indexOf("--scope");if(n>=0){let s=e[n+1];if(s!=="global"&&s!=="project"&&s!=="both")throw new Error(`Invalid --scope value: ${String(s)}`);o.push(s)}e.includes("--global")&&o.push("global"),e.includes("--both")&&o.push("both");let r=Array.from(new Set(o));if(r.length>1)throw new Error(`Conflicting integration scopes: ${r.join(", ")}`);return r[0]??t.defaultScope??"global"}function Ao(e,t){return{install:e,effective:t}}function w(e,t){return{surface:e,global:Ao(t.globalInstall,t.effective==="global"||t.effective==="both"),project:Ao(t.projectInstall,t.effective==="project"||t.effective==="both"),effective:t.effective,risk:t.risk??"none",dedupeRequired:t.dedupeRequired??!1,trustRequired:t.trustRequired??t.projectInstall,note:t.note}}function ls(e){return{mcp:w("mcp",{globalInstall:!0,projectInstall:!1,effective:"global"}),hooks:w("hooks",{globalInstall:!0,projectInstall:!1,effective:"global"}),work:w("work",{globalInstall:e==="grok",projectInstall:!1,effective:e==="grok"?"global":"none",note:e==="grok"?"Grok supports a global ToolNet continuity skill.":"Cursor/Copilot work instructions remain project-scoped."})}}function No(e){return{mcp:w("mcp",{globalInstall:!1,projectInstall:!0,effective:"project",trustRequired:!0}),hooks:w("hooks",{globalInstall:!1,projectInstall:!0,effective:"project",trustRequired:!0}),work:w("work",{globalInstall:!1,projectInstall:!0,effective:"project",trustRequired:!1,note:e==="cursor"?"Use .cursor/rules/toolnet-memory.mdc.":e==="copilot"?"Use .github/instructions/toolnet-memory.instructions.md.":"Use .grok/skills/toolnet-continuity/SKILL.md."})}}function _o(e){return{mcp:w("mcp",{globalInstall:!0,projectInstall:!0,effective:"project",risk:e==="cursor"?"precedence-unverified":"shadowed-global",trustRequired:!0,note:e==="cursor"?"Project ToolNet MCP is the intended effective definition; native same-name precedence must be E2E certified before release.":"Global remains useful outside the project; same-name project definition wins inside the project."}),hooks:w("hooks",{globalInstall:!0,projectInstall:!0,effective:"both",risk:"additive-duplicate",dedupeRequired:!0,trustRequired:!0,note:"Global and project hook sources can both execute for the same native event."}),work:w("work",{globalInstall:e==="grok",projectInstall:!0,effective:"project",risk:e==="grok"?"shadowed-global":"none",trustRequired:!1,note:e==="cursor"?"Project rule is authoritative.":e==="copilot"?"Project instruction is authoritative.":"Project skill shadows the same-name global skill inside the project."})}}function F(e){let{agent:t,scope:o,project:n}=e;return(o==="project"||o==="both")&&(!n||!n.eligible)?{agent:t,requestedScope:o,project:n,surfaces:o==="both"?_o(t):No(t),canInstall:!1,reason:"Project scope requires an explicit project, existing ToolNet project, or Git repository root."}:{agent:t,requestedScope:o,project:n,surfaces:o==="global"?ls(t):o==="project"?No(t):_o(t),canInstall:!0}}function $o(e){return!!(e?.mcp?.changed||e?.hooks?.changed||e?.rule?.changed)}function Ho(e={}){let t=e.binary??process.env.TOOLNET_MEMORY_BIN??"toolnet-memory",o=e.scope??"global",n=o==="global"?void 0:C({project:e.projectRoot}),r=F({agent:"cursor",scope:o,project:n});if(!r.canInstall)throw new Error(r.reason??"Cursor project integration scope cannot be resolved.");let s,i;if((r.surfaces.mcp.global.install||r.surfaces.hooks.global.install||r.surfaces.work.global.install)&&(s={},r.surfaces.mcp.global.install&&(s.mcp=Je({binary:t,configFile:e.configFile??Q()})),r.surfaces.hooks.global.install&&(s.hooks=He({binary:t,hooksFile:e.hooksFile??Z()}))),r.surfaces.mcp.project.install||r.surfaces.hooks.project.install||r.surfaces.work.project.install){if(!n?.eligible)throw new Error("Cursor project integration requires an eligible project root.");i={},r.surfaces.mcp.project.install&&(i.mcp=Je({binary:t,configFile:e.projectConfigFile??vt(n.root)})),r.surfaces.hooks.project.install&&(i.hooks=He({binary:t,hooksFile:e.projectHooksFile??Ot(n.root)})),r.surfaces.work.project.install&&(i.rule=Fo({projectRoot:n.root,ruleFile:e.projectRuleFile}))}let c=i?.mcp??s?.mcp,a=i?.hooks??s?.hooks;if(!c||!a)throw new Error("Cursor integration did not produce an effective MCP/hooks installation.");let l=Array.from(new Set([s?.mcp?.configFile,s?.hooks?.hooksFile,s?.rule?.ruleFile,i?.mcp?.configFile,i?.hooks?.hooksFile,i?.rule?.ruleFile].filter(u=>typeof u=="string")));return{installed:!0,changed:$o(s)||$o(i),scope:o,plan:r,project:n,global:s,projectScope:i,mcp:c,hooks:a,rule:i?.rule,files:l}}var G=[["sessionStart",10],["userPromptSubmitted",10],["userPromptTransformed",10],["preToolUse",10],["postToolUse",15],["agentStop",30]];function us(e){if(typeof e.command=="string")return e.command;if(typeof e.bash=="string")return e.bash}function Jo(e){return g(e)&&us(e)?.includes("session:copilot-hook")===!0}function ps(e,t,o){let n={type:"command",command:`${t} session:copilot-hook`,env:{TOOLNET_HOOK_EVENT:e},timeoutSec:o};return e==="preToolUse"&&(n.matcher=".*"),n}function Be(e={}){let t=e.hooksFile??te(),o=e.binary??process.env.TOOLNET_MEMORY_BIN??"toolnet-memory",n=b(t,"GitHub Copilot CLI");if(n.version!==void 0&&n.version!==1)throw new Error(`Unsupported existing GitHub Copilot CLI hooks version: ${String(n.version)}`);let r=n.hooks;if(r!==void 0&&!g(r))throw new Error("Invalid existing GitHub Copilot CLI hooks file: hooks must be an object.");let s=g(r)?{...r}:{};for(let[l,u]of G){let p=s[l];if(p!==void 0&&!Array.isArray(p))throw new Error(`Invalid existing GitHub Copilot CLI hooks file: hooks.${l} must be an array.`);let d=Array.isArray(p)?p.filter(P=>!Jo(P)):[];s[l]=[...d,ps(l,o,u)]}let i={...n,version:1,hooks:s};if(JSON.stringify(n)===JSON.stringify(i))return{hooksFile:t,changed:!1,hookCount:G.length};T(t,i);let c=b(t,"GitHub Copilot CLI");if(c.version!==1||!g(c.hooks))throw new Error("GitHub Copilot CLI hooks were written but verification failed.");let a=0;for(let[l]of G){let u=c.hooks[l];if(!Array.isArray(u))throw new Error("GitHub Copilot CLI hooks were written but verification failed.");a+=u.filter(Jo).length}if(a!==G.length)throw new Error("GitHub Copilot CLI hooks were written but verification failed.");return{hooksFile:t,changed:!0,hookCount:G.length}}function Lo(e,t){return m(e)?(e.type===void 0||e.type==="local"||e.type==="stdio")&&e.command===t&&Array.isArray(e.args)&&e.args.length===1&&e.args[0]==="mcp"&&Array.isArray(e.tools)&&e.tools.length===1&&e.tools[0]==="*":!1}function Ue(e={}){let t=e.configFile??ee(),o=e.binary??process.env.TOOLNET_MEMORY_BIN??"toolnet-memory",n=e.serverName??"toolnet-memory",r=O(t,"GitHub Copilot CLI"),s=r.mcpServers;if(s!==void 0&&!m(s))throw new Error("Invalid existing GitHub Copilot CLI MCP config: mcpServers must be an object.");let i=m(s)?{...s}:{};if(Lo(i[n],o))return{installed:!0,changed:!1,configFile:t,serverName:n,command:o,args:["mcp"]};i[n]={type:"stdio",command:o,args:["mcp"],tools:["*"]},M(t,{...r,mcpServers:i});let a=O(t,"GitHub Copilot CLI").mcpServers;if(!m(a)||!Lo(a[n],o))throw new Error("GitHub Copilot CLI MCP configuration was written but verification failed.");return{installed:!0,changed:!0,configFile:t,serverName:n,command:o,args:["mcp"]}}import{mkdirSync as ds,readFileSync as Go,renameSync as gs,rmSync as fs,writeFileSync as ms}from"node:fs";import{dirname as ys}from"node:path";var Ye=`---
applyTo: "**"
---
