...
`;return p+f+y+g+E}function je(r={}){let t=r.projectPath||process.cwd(),e=C(t);if(!e)throw new Error("Not in a ToolNet project (no .toolnet directory found)");let n=h.join(e,".toolnet","profile.md"),s=h.join(e,".toolnet","current.md"),i=_(n)||"",a=_(s)||"",l=`# AI Startup Instructions
