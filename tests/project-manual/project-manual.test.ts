...
describe(
  ...
  () => {
    it(
      "creates PROJECT.md and parses enforce/advisory rules",
      () => {
        const p =
          project();
...
`,
    ...
    it(
      "syncs manual into project namespace",
      async () => {
        const p =
          project();
        ...
        expect(
          await storage.exists(
            `projects/${p.id}/project/manual.md`,
          ),
        ).toBe(
          true,
        );
        ...
        expect(
          await storage.exists(
            `projects/${p.id}/project/manual.json`,
          ),
        ).toBe(
          true,
        );
