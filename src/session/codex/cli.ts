...
async function main() {
  ...
  if (
    ...
    console.log(
      `✅ Codex notify installed: ${result.configFile}`,
    );
  ...
  if (
    ...
    if (
      ...
      throw new Error(
        `Codex rollout not found for ${threadId}`,
      );
    }
