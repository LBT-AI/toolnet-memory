  ...
  for (
    ...
    for (
      ...
      for (
        ...
        if (
          /^(?:acceptance criteria|definition of done|done khi|tiêu chí hoàn thành)\s*:?\s*$/iu
            .test(
              line,
            )
        ) {
        ...
        if (
          /^(?:dependencies|dependency|phụ thuộc)\s*:?\s*$/iu
            .test(
              line,
            )
        ) {
        ...
        if (
          /^(?:open questions|open question|câu hỏi mở)\s*:?\s*$/iu
            .test(
              line,
            )
        ) {
        ...
        if (
          /^(?:constraints|constraint|ràng buộc)\s*:?\s*$/iu
            .test(
              line,
            )
        ) {
